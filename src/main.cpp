...
int main(int argc, char** argv)
{
	...
	pWindow = glfwCreateWindow(g_windowSize.x, g_windowSize.y, "Battle-Sity", nullptr, nullptr);
	if (!pWindow)
	{
...

	{
		...
		if (pDefaultShaderProgram == nullptr)
		{
			std::cout << "Error load Sprite shader program" << std::endl;
			return -1;
		}

		auto tex = resourceManager.loadTexture("defaulttextur", "res/textures/map_16x16.png");

		auto pSprite = resourceManager.loadSprite("NewSprite", "defaulttextur", "SpriteShader", 50, 100);
